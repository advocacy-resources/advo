...
export const createResource = async (data: Prisma.ResourceCreateInput): Promise<Resource> => {
...
export const updateResource = async (id: string, data: Prisma.ResourceUpdateInput): Promise<Resource> => {
...
export const createAccount = async (data: Prisma.AccountCreateInput): Promise<Account> => {
...
export const updateAccount = async (id: string, data: Prisma.AccountUpdateInput): Promise<Account> => {
