// File: src/components/resources/ResourceForm.tsx
// Purpose: Form component for creating and editing resource entries.
// Owner: Advo Team
...
/**
 * Type definition for the form data, excluding read-only fields.
 * Omits fields that are generated by the server or not editable by users.
 */
type FormData = Omit<
  Resource,
...
/**
 * Form component for creating and editing resource information.
 * Provides input fields for all resource properties and handles form submission.
 *
 * @returns React component with the resource form UI
 */
const ResourceForm: React.FC = () => {
  ...
  /**
   * Handles changes to form input fields and updates the form state.
  ...
  /**
   * Handles changes to nested form fields (contact, address, operating hours).
   * Updates the appropriate nested object in the form state.
   *
   * @param e - The change event from the input field
   * @param section - The section of the form to update (contact, address, or operatingHours)
   */
  ...
  /**
   * Updates the category selection in the form state.
   *
  ...
  /**
   * Handles form submission by sending the resource data to the API.
   * Redirects to the resources page on success.
   *
