...
export async function GET(
  ...
  try {
    ...
    const imageData =
      type === "profile" ? resource.profilePhoto : resource.bannerImage;

    const mimeType =
      type === "profile" ? resource.profilePhotoType : resource.bannerImageType;

    const imageUrl =
      type === "profile" ? resource.profilePhotoUrl : resource.bannerImageUrl;
